...
public class ReceiveNfcTransfer extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receive_nfc_transfer);
    ...
    public void wifi(String ssid, String password) {
